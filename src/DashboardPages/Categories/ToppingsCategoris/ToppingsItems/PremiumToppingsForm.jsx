...
function PremiumToppingsForm({ setIsFormOpen, setProducts, products }) {
        ...
        <div className="w-full mx-auto py-[20px]  px-[30px] bg-white   rounded-lg">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-[25px]">
            ...
            <div className="flex flex-col gap-[20px]">
              ...
              <div className="flex  items-center pl-[20px]  justify-between">
                <button
                  type="button"
                  className="w-[210px] h-[50px] rounded-[20px] border-solid border-[1px] border-[#088D56] InterFont font-[400] text-[20px] leading-[24.2px] text-[#000000A6] "
                >
                  Popular Toppings
                </button>
                <button
...
export default PremiumToppingsForm;
