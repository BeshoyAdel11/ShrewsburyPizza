...
function ToppingsCategoriesFoorm({ setIsFormOpen, setProducts, products }) {
  ...
  const handleSubmit = (e) => {
    ...
    localStorage.setItem("ToppingsCategories", JSON.stringify(updatedProducts));
...
export default ToppingsCategoriesFoorm;
